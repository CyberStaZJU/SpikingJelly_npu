...
class KernelAsPyIfCompactForward {
 public:
  __aicore__ inline KernelAsPyIfCompactForward() = default;
  ...
  __aicore__ inline void Init(
      ...
      GM_ADDR v_final,
      GM_ADDR h_seq,
      const AsPyIfCompactForwardTilingData& tiling) {
...
extern "C" __global__ __aicore__ void as_py_if_compact_forward(
    GM_ADDR xSeq,
    GM_ADDR vInit,
    GM_ADDR spikeSeq,
    GM_ADDR vFinal,
  ...
  KernelAsPyIfCompactForward kernel;
  kernel.Init(xSeq, vInit, spikeSeq, vFinal, hSeq, tiling_data);
  kernel.Process();
}
