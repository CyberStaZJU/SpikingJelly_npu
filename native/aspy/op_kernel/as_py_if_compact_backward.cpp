...
class KernelAsPyIfCompactBackward {
 public:
  __aicore__ inline KernelAsPyIfCompactBackward() = default;
  ...
  __aicore__ inline void Init(
      ...
      GM_ADDR grad_x_seq,
      GM_ADDR grad_v_init,
      const AsPyIfCompactBackwardTilingData& tiling) {
...
extern "C" __global__ __aicore__ void as_py_if_compact_backward(
    GM_ADDR hSeq,
    GM_ADDR spikeSeq,
  ...
  KernelAsPyIfCompactBackward kernel;
  kernel.Init(
      hSeq,
      spikeSeq,
      gradSpikeSeq,
