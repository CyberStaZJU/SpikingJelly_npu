...
class KernelAsPyPlifForward {
 public:
  __aicore__ inline KernelAsPyPlifForward() = default;
  ...
  __aicore__ inline void Init(
      ...
      GM_ADDR h_seq,
      GM_ADDR v_prev_seq,
      const AsPyPlifForwardTilingData& tiling) {
...
extern "C" __global__ __aicore__ void as_py_plif_forward(
    GM_ADDR xSeq,
    GM_ADDR vInit,
  ...
  KernelAsPyPlifForward kernel;
  kernel.Init(
      xSeq, vInit, reciprocalTau, spikeSeq, vSeq, vFinal, hSeq, vPrevSeq,
      tiling_data);
  kernel.Process();
}
