...
class KernelAsPyLifCompactForward {
 public:
  __aicore__ inline KernelAsPyLifCompactForward() = default;
  ...
  __aicore__ inline void Init(
      ...
      GM_ADDR v_final,
      GM_ADDR h_seq,
      const AsPyLifCompactForwardTilingData& tiling) {
...
extern "C" __global__ __aicore__ void as_py_lif_compact_forward(
    GM_ADDR xSeq,
    GM_ADDR vInit,
    GM_ADDR spikeSeq,
    GM_ADDR vFinal,
  ...
  KernelAsPyLifCompactForward kernel;
