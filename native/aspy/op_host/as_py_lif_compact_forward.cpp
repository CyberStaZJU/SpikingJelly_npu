...
#include "as_py_lif_compact_forward_tiling.h"
...
static ge::graphStatus TilingFunc(gert::TilingContext* context) {
  ...
  AsPyLifCompactForwardTilingData tiling;
...
namespace ops {
class AsPyLifCompactForward : public OpDef {
 public:
  explicit AsPyLifCompactForward(const char* name) : OpDef(name) {
