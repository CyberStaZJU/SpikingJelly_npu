...
#include "as_py_lif_compact_backward_tiling.h"
...
static ge::graphStatus TilingFunc(gert::TilingContext* context) {
  ...
  AsPyLifCompactBackwardTilingData tiling;
...
namespace ops {
class AsPyLifCompactBackward : public OpDef {
 public:
  explicit AsPyLifCompactBackward(const char* name) : OpDef(name) {
